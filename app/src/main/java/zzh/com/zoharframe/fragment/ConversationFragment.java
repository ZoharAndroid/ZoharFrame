...
import zzh.com.zoharframe.activity.conversation.DragPointActivity;
...
import zzh.com.zoharframe.activity.conversation.MobSMSActivity;
...
public class ConversationFragment extends BaseFragment {
    ...
    private String[] dataNameList = new String[]{
            "RecyclerView显示", "RecyclerView的Gallery效果", "CardView与RecyclerView结合使用",
            "RecyclerView的GridLayout/分割线", "沉浸式模式", "SwipeRefresh上下拉刷新",
            "RecyclerView侧滑菜单", "Zxing二维码", "NiceDialog各种类型Dialog",
            "DragPoint随手指滑动的点", "Mob短信验证"};
    private Class<?>[] activities = new Class<?>[]{
            RecyclerActivity.class, RecyclerGalleryActivity.class, CardRecyclerActivity.class,
            GridRecyclerActivity.class, ImmersiveModeActivity.class, SwipeRefreshLayoutActivity.class,
            ItemSlideMenuRecyclerActivity.class, ZxingCodeActivity.class, MyNiceDialogActivity.class,
            DragPointActivity.class, MobSMSActivity.class};
